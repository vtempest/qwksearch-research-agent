...
export const COMPARISON_ROWS: ComparisonRow[] = [
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "no", note: "Hosted product; serves open-weight models" },
    ],
  },
  {
  ...
  },
  {
    ...
    cells: [
      ...
      { status: "no", note: "xAI / Grok models only" },
      {
        status: "yes",
        note: "Varies by plan and privacy mode; open models plus some third-party frontier options",
      },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "partial", note: "Web-focused AI search" },
      { status: "partial", note: "Web browsing / search when enabled" },
      { status: "partial", note: "Web search when enabled" },
      { status: "yes", note: "Broad web index; Gemini synthesis varies by surface" },
      { status: "yes", note: "Real-time web and X search (DeepSearch / API tools)" },
      {
        status: "yes",
        note: "Web search with provider choice; scraping and X search on Grok-backed flows",
      },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "yes", note: "Inline source citations; APA export is not the focus" },
      { status: "partial", note: "Depends on browsing / research mode; no APA workflow" },
      { status: "partial", note: "Depends on web-search workflow; no APA workflow" },
      { status: "partial", note: "Citations and source links vary by surface" },
      { status: "partial", note: "Citations when search tools run; no APA bibliography" },
      { status: "partial", note: "Clickable citations on web search; no APA formatting" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "partial", note: "File / PDF analysis; YouTube support varies" },
      { status: "yes", note: "Common document uploads; video is less research-native" },
      { status: "yes", note: "Common document uploads; limited YouTube workflow" },
      { status: "partial", note: "Files in Gemini; YouTube varies by product" },
      { status: "yes", note: "Multi-document attachment & search; varies by plan" },
      { status: "yes", note: "Document upload & analysis; formats and limits vary" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no", note: "Research workspace, not a writing editor" },
      { status: "no", note: "Canvas / chat workspace" },
      { status: "no", note: "Artifacts / chat workspace" },
      { status: "no", note: "Document tools, but no research writing environment" },
      { status: "partial", note: "Projects organize work, but not a writing IDE" },
      { status: "no", note: "Chat-oriented interface" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "yes", note: "Yes" },
      { status: "partial", note: "Varies by platform" },
      { status: "partial", note: "Availability and capability vary" },
    ],
  },
  {
    feature: "Desktop app",
    cells: [
      ...
      { status: "yes", note: "Yes" },
      { status: "yes", note: "Yes" },
      { status: "yes", note: "Depends on platform and rollout" },
      { status: "partial", note: "Primarily web and mobile" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "partial", note: "Developer / API tools, no first-party IDE" },
      { status: "partial", note: "OpenAI-compatible API for third-party IDE tooling" },
    ],
  },
  {
    ...
    cells: [
      { status: "yes", note: "Yes" },
      { status: "partial", note: "Limited / private modes vary" },
      { status: "partial", note: "Temporary chat and data controls" },
      { status: "partial", note: "Data controls vary" },
      { status: "partial", note: "Varies by account and product" },
      { status: "partial", note: "Settings vary; not privacy-first" },
      {
        status: "yes",
        note: "Anonymous by default; TEE / E2EE on Pro, which disables web search and memory",
      },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "paid", note: "Freemium / subscription" },
      { status: "paid", note: "Freemium / paid tiers" },
    ],
  },
];
