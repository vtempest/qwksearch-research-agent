...
description: "Superseded integration plan for inverting the architecture around packages-lobe."
---
...
| REASON writing editor | `reason-editor` (see [`REASON_EDITOR.md`](./reason-editor)) | LobeHub's editor is `@lobehub/editor` (chat input); REASON is a full document organizer |
...
- **0.2** ✅ This plan + [`REASON_EDITOR.md`](./reason-editor).
...
Details in [`REASON_EDITOR.md`](./reason-editor); summary:
